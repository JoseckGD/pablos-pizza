...
export default class UserRepository {
    ...
    async getUsers() {
        return new Promise((resolve, reject) => {
            const query = 'SELECT *, roles.nombre as ROL FROM usuarios INNER JOIN personas ON personas.id = usuarios.persona _id INNER JOIN roles ON roles.id = usuarios.rol_id';
